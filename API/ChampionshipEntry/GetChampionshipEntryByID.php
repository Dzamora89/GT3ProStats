...
$championshipEntry_Array = array(
    ...
    'championshipID' => $championshipEntry->championshipID,
    'totalPoints' => $championshipEntry->totalPoints,
    'position' => $championshipEntry->position,
    'class' => $championshipEntry->class);

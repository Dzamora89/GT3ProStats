...
(7, 'Andrea ', 'Bertolini ', 'Italian', '1973-12-01', 'http://andreabertolini.it/', 'https://twitter.com/abracing73', NULL, NULL, 1500),
(8, 'Timur ', 'Boguslavskiy ', 'Russian', NULL, 'http://timurboguslavskiy.com/', NULL, NULL, NULL, 1500),
(9, 'Mirko ', 'Bortolotti ', 'Italian', '1990-01-10', NULL, 'https://twitter.com/M_Bortolotti', NULL, NULL, 1500),
...
(15, 'Christian ', 'Engelhart ', 'German', '1986-12-13', 'http://christian-engelhart.de/', 'https://twitter.com/engelhartchris', NULL, NULL, 1500),
(16, 'Maro ', 'Engel ', 'German', '1985-08-27', 'http://maroengel.com/', 'https://twitter.com/MaroEngel', NULL, NULL, 1500),
(17, 'Philip ', 'Ellis ', 'British', '1992-10-09', 'http://philip-ellis.com/?fbclid=IwAR2TY5USBL7DLU1Lfo8KHUBhngILko', NULL, NULL, NULL, 1500),
(18, 'Kevin ', 'Estre ', 'French', '1988-10-28', NULL, NULL, NULL, NULL, 1500),
(19, 'Augusto ', ' Farfus ', 'Brazilian', '0000-00-00', 'http://farfus.com/', 'https://twitter.com/augustofarfus', NULL, NULL, 1500),
(20, 'Chris ', 'Froggatt ', 'British', '1993-12-11', NULL, NULL, NULL, NULL, 1500),
(21, 'Antonio ', 'Fuoco ', 'Italian', '1996-05-20', 'http://antonio-fuoco.com/', 'https://twitter.com/Anto_Fuoco', NULL, NULL, 1500),
(22, 'Maxi ', 'Götz ', 'German', '1986-02-04', 'http://maximilian-goetz.de/', 'https://twitter.com/max_goetz?lang=de', NULL, NULL, 1500),
(23, 'Jules ', 'Gounon ', 'French', '1994-12-31', 'http://julesgounon.com/', 'https://twitter.com/julesgounon', NULL, NULL, 1500),
(24, 'Christopher ', 'Haase ', 'German', '1987-09-26', 'http://christopher-haase.de/', 'https://twitter.com/chhaase', NULL, NULL, 1500),
...
(27, 'Marco ', 'Mapelli ', 'Italian', '1987-08-01', 'http://marcomapelli.net/', 'https://twitter.com/marcomapelli', NULL, NULL, 1500),
(28, 'Raffaele ', 'Marciello ', 'Italian', '1994-12-17', 'http://raffaelemarciello.com/', 'https://twitter.com/real_rmarciello', NULL, NULL, 1500),
(29, 'Miguel ', 'Molina ', 'Spanish', '1989-02-17', NULL, 'https://twitter.com/miguelmolinam2', NULL, NULL, 1500),
(30, 'Christopher ', 'Mies ', 'German', '1989-05-24', 'http://christopher-mies.de/', 'https://twitter.com/mieschris', NULL, NULL, 1500),
...
(33, 'Nico ', 'Müller ', 'Swiss', '1992-02-25', 'http://nicomueller.ch/', 'https://twitter.com/nico_mueller', NULL, NULL, 1500),
(34, 'Aurélien ', 'Panis ', 'French', '1994-08-29', NULL, 'https://twitter.com/AurelienPanis', NULL, NULL, 1500),
(35, 'David ', 'Perel ', 'South African', '1985-05-07', 'http://davidperel.net/', 'https://twitter.com/davidperel', NULL, NULL, 1500),
(36, 'Jordan ', 'Pepper ', 'South African', '1996-07-31', 'http://jordan-pepper.com/', 'https://twitter.com/jordanpepper46', NULL, NULL, 1500),
...
(42, 'Alessio ', 'Rovera ', 'Italian', '1995-06-22', 'http://.alessiorovera.net/?fbclid=IwAR20J8wq_E4lpnz5bC5WX7D0Z8V9b5dOD8fIEdWZjrGNJc6rMOEKn5MRHAQ', NULL, NULL, NULL, 1500),
...
(49, 'Laurens ', 'Vanthoor ', 'Belgium', '1991-05-08', 'http://laurensvanthoor.be/', 'https://twitter.com/vanthoorlaurens', NULL, NULL, 1500),
...
(1, 'AF Corse', 'Amato Ferrari', 'Italian ', 'https://twitter.com/afcorse', 'http://afcorse.it/', 'Ferrari '),
(2, 'Akkodis ASP Team', 'Jérôme Policand', 'France', 'https://twitter.com/AKKAASPTEAM', 'http://akka-asp-team.com/fr/', 'Mercedes-AMG'),
...
(6, 'Beechdean AMR', 'Andrew Howard', 'British', 'https://twitter.com/beechdeanamr', 'http://beechdeanamr.com/', 'Aston Martin'),
...
(10, 'Iron Lynx', 'DEBORAH MAYER, CLAUDIO SCHIAVONI, SERGIO PIANEZZOLA AND ANDREA PICCINI', 'ITALY', NULL, 'http://ironlynx.it/', 'Ferrari '),
...
(14, 'Sainteloc Racing', 'Sébastien Chetail.', 'French ', 'https://twitter.com/TeamSainteloc', 'http://sainteloc.com/', 'Audi '),
...
(17, 'Team WRT', 'Vincent Vosse, Yves Weerts', 'Belgian ', 'https://twitter.com/followWRT', 'http://w-racingteam.com/', 'AUDI'),
...
ALTER TABLE `raceresult`
  ...
  ADD KEY `RaceResult_CarID_FK` (`carID`),
...
ALTER TABLE `raceresult`
  ...
  ADD CONSTRAINT `RaceResult_RaceID_FK` FOREIGN KEY (`raceID`) REFERENCES `race` (`raceID`);
COMMIT;
